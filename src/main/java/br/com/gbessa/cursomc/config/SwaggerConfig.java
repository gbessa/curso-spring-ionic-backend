...
public class SwaggerConfig extends WebMvcConfigurationSupport {
	...
	return new Docket(DocumentationType.SWAGGER_2)
		...
		.select()
		.apis(RequestHandlerSelectors.basePackage("br.com.gbessa.cursomc.resources")).paths(PathSelectors.any())
		.build().apiInfo(metaData());
    }

    private ApiInfo metaData() {
	return new ApiInfoBuilder().title("API do curso de Spring Boot")
		.description("Esta API é usada no curso do Prof. Nelio Alves").version("1.0.0")
		.contact(new Contact("Gustavo Bessa", "www.hoptech.com.br", "hoptech.ti@gmail.com")).build();
    }
